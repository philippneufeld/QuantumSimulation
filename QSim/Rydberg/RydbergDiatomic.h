...
namespace QSim
{
    ...
    public:
        ...
        double GetCoreInteractionHcb(int n1, int l1, int R1, int n2, 
            int l2, int R2, int lambda, int N) const;
        double GetCoreInteractionME(const RydbergDiatomicState_t& state1, 
            const RydbergDiatomicState_t& state2) const;
        ...
        static double GetHcbToHcdCoeff(int N, int l, int R, int lambda);
    };
